<div class="jumbotron well">
    ...
    <div class="row">
        <div class ="instructions col-md-12" align="center">
            <h2><b>Modify this Recipe.</b></h2><h4> Fill in the associated textbox and click the button to rename Titles, add Ingredients, or delete Ingredients from the recipe.</h4>
        </div>
    </div>
